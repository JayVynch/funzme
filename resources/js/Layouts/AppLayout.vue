    ...
    <div>
        ...
        <div class="min-h-screen bg-pink-50">
            <nav class="bg-gradient-to-r from-purple-800 to-pink-800 border-b border-purple-100 ">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        ...
                        <div class="-mr-2 flex items-center sm:hidden">
                            <button @click="showingNavigationDropdown = ! showingNavigationDropdown" class="inline-flex items-center justify-center rounded-md text-white  focus:outline-none  focus:text-white transition duration-150 ease-in-out ml-2">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden bg-white mb-4">
